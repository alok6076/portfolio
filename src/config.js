...
const mySkills = ["Machine Learning", "Notebook", "AI", "Python TENSORFLOW PANDAS"," NUMPY MATPLOTLIB"," OpenCV","react", "redux", "vue", "nodejs", "expressjs", "mongodb", "git",];
...
export { contactLinks, personalDetails, mySkills, projectDetails, themeColors };